    ...
    <div className="relative min-h-screen w-full overflow-hidden">
      ...
      <div className="relative z-10 flex min-h-screen items-center">
        <div className="container mx-auto px-4 mt-20">
          <div className="">
 <h1 className="text-4xl md:text-5xl font-light text-green-800 mb-4 park">
              <span className="font-semibold text-[#249CF7]">Zenon</span> Hiring 
             <span className="text-[#F49623]"></span> Solutions.
            </h1>
