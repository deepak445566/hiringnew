          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="text-white">
              ...
              <p className="text-white/90 text-lg mb-8">
                Zenon Hiring Solutions is your trusted recruitment partner in , dedicated to bridging the gap between exceptional talent and leading organizations across India.
              </p>
