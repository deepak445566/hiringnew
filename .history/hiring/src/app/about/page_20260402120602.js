          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="text-white">
              ...
              <p className="text-white/90 text-lg mb-8">
                Zenon Hiring Solutions is your trusted recruitment partner in Noida, dedicated to bridging the gap between exceptional talent and leading organizations across India.
              </p>
      ...
      <div className="container mx-auto px-4 -mt-16 relative z-10">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
          ...
          <div className="bg-white rounded-2xl p-4 md:p-6 shadow-xl hover:shadow-2xl transition-all duration-300 text-center">
            ...
            <div className="text-2xl md:text-3xl font-bold text-[#18403C]">55+</div>
          ...
          <div className="fade-up-element" id="who-we-are">
            ...
            <div className="flex items-center gap-4 mt-6">
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-600">dehradun</span>
              </div>
              <div className="flex items-center gap-2">
