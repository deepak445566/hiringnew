          ...
          <div className="max-w-3xl mx-auto">
            ...
            <form className="space-y-6">
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <label className="block text-[#18403C] font-semibold mb-2">Full Name *</label>
                  <input 
                    type="text" 
                    placeholder="John Doe"
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#18403C] focus:border-transparent transition-all"
                  />
                </div>
                <div>
                  <label className="block text-[#18403C] font-semibold mb-2">Email Address *</label>
                  <input 
                    type="email" 
              ...
              <div>
                <label className="block text-[#18403C] font-semibold mb-2">Phone Number</label>
                <input 
                  type="tel" 
              ...
              <div>
                <label className="block text-[#18403C] font-semibold mb-2">Subject *</label>
                <input 
                  type="text" 
              ...
              <div>
                <label className="block text-[#18403C] font-semibold mb-2">Message *</label>
                <textarea 
                  rows={5}
                  placeholder="Tell us more about your inquiry..."
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#18403C] focus:border-transparent transition-all resize-none"
                ></textarea>
              </div>

              <button 
                type="submit"
                className="w-full bg-gradient-to-r from-[#18403C] to-[#2c6b64] text-white py-3 rounded-lg font-semibold hover:shadow-lg transform hover:scale-[1.02] transition-all duration-300"
              >
                Send Message →
              </button>
            </form>
