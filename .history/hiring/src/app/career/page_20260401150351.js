          ...
          <form onSubmit={handleSubmit} className="p-6 md:p-8 space-y-6">
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-4 py-3 text-black border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-400 focus:border-transparent outline-none resize-none bg-gray-50 focus:bg-white"
              ></textarea>
            </div>
