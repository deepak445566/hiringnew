...
const career = () => {
  ...
  const jobOptions = [
    ...
    { value: 'ppc-engineer', label: 'PPC Engineer' },
  ...
  { value: 'r-and-d-engineer', label: 'R&D Engineer' },
  { value: 'design-engineer', label: 'Design Engineer' },
  { value: 'graduate-engineer-trainee', label: 'Graduate Engineer Trainee' },
          ...
          <form onSubmit={handleSubmit} className="p-6 md:p-8 space-y-6">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 border text-black border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-400 focus:border-transparent outline-none transition bg-gray-50 focus:bg-white"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 text-black border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-400 focus:border-transparent outline-none transition bg-gray-50 focus:bg-white"
              />
            </div>
            ...
            <div>
              ...
              <select
                ...
                onChange={handleChange}
                className="w-full px-4 py-3text-black border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-400 focus:border-transparent outline-none bg-gray-50 focus:bg-white cursor-pointer"
              >
